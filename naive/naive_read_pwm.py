...
steering_pin = Pin(15, Pin.IN) # GP15, Pin 20 - Channel 3 on Traxxas Receiver
throttle_pin = Pin(13, Pin.IN) # GP13, Pin 17 - Channel 1 on Traxxas Receiver
    ...
    while True:
        ...
        if (steering_value == True) & (last_state_steering == False):
            ...
            if (steering_value == False) & (last_state_steering == True):
                ...
                steering_us = ticks_diff(steering_stop, steering_start)
